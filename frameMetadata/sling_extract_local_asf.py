        ...
        for i in os.listdir(cache_dir):
            ...
            if os.path.isdir(cached_obj):
                ...
                try:
                    ...
                    raise RuntimeError("Failed to soft link {} to {}".format(cached_obj, dst))
            else:
                try:
...
def rename_file(orig_file_name):
    ...
    if not file_name.endswith("-local"):
        new_file_name = "{}-local{}".format(filename, file_extension)
