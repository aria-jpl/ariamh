...
def create_alos2_md_isce(dirname, filename):
    ...
    print(track)
    print("track.radarwavelength : {}".format(track.catalog['radarwavelength']))    
...
if __name__ == '__main__':
    #insar_obj = get_alos2_obj("/sp_data/alos2/david/reference/")
    create_alos2_md_isce("/sp_data/alos2/david/reference/", "test2.json")
