...
export PYTHONPATH=.:$WORK_DIR:$ISCE_HOME/applications:$ISCE_HOME/components:$BASE_PATH:$ARIAMH_HOME:$ARIAMH_HOME/interferogram:$TROPMAP_HOME:$GIANT_HOME:$UTILS_HOME:$PYTHONPATH
...
export PATH=$BASE_PATH:$TROPMAP_HOME:$GMT_HOME/bin:$WORK_DIR:$PATH
echo $PYTHONPATH
# source environment
